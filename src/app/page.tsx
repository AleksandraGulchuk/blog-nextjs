    ...
    return (
        <main className="flex items-center justify-center min-h-screen bg-gray-50">
            <div className="container mx-auto p-4 relative">
                <div
                    className="bg-white border-2 border-purple-100 rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col justify-center">
                        <h1 className={`text-4xlfont-bold mb-4 ${styles.text_wisteria}`}>Welcome</h1>
                        <p className="text-lg text-gray-700 mb-4">
                            Welcome to a world where your words matter - share your thoughts, inspire others, and make
                            every story count.
                        </p>
                        <a href="/blog/posts"
